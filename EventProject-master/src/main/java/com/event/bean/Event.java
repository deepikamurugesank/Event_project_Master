...
public class Event {
	...
	public Event(Long eId,int eEdition, String eFullDte, String eDate, String eMonth, String eLocation, Boolean eIsActive,List<Agenda> ag) 
	{
		super();
	...
	public void setAgenda(List<Agenda> ag) {
		this.ag = ag;
	}
